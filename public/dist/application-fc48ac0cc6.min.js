...
"use strict";angular.module("core").controller("ServiceAlertsController",["$scope",function(r){r.alerts=[{type:"danger",msg:"Pronouny is running on a partially upgraded core, errors are likely to occur."}],r.closeAlert=function(e){r.alerts.splice(e,1)}}]);
